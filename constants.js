window.AppConstants = {
  ...
  STANDBY_OTHER_MOVE_RANGE: 180,
  STANDBY_FINISH_TOP: 96,
  ...
  cardClass: "rounded-[28px] bg-white/85 backdrop-blur border border-white/60 shadow-[0_8px_16px_rgba(0,0,0,0.10)]",
  mainButtonBase:
